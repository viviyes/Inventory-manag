  ...
  return (
    <Link href={href}>
      <div className={`cursor-pointer flex items-center ${
        isCollapsed ? 'justify-center py-6' : 'justify-start px-8 py-4'
  ...
  return (
    <div className={sidebarClass}>
      ...
      <div className={`flex gap-3 justify-between md:justify-normal items-center pt-8 ${
        ...
        <div><img src={isDarkMode ? "/stocklogo-white.png" : "/stocklogo.png"} alt="logo"/></div>
        <h1 className={`${
      ...
      <div className={`${isSidebarCollapsed ? 'hidden' : 'block'} mb-10`}>
        <p className="text-center text-xs text-gray-500">&copy;2025 Vivi</p>
      </div>
    </div>
  );
};
